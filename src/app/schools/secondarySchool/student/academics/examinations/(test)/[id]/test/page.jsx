...
import { showProgress } from "../../../../../../../../../../lib/helpers"
import { Button } from "../../../../../../../../_components/cards/button"
    
const Test = () => {
    const params = useParams()
    const { id } = params
    const { selected, currentQuestion, setTotalQuestions, setSubmitModal, setExamDuration } = useContext(examContext)
    ...
    //update progress bar
    const currentProgress = showProgress(progress, question?.total)
    ...
    return (
        <main className="w-full">
            <section className="flex justify-between items-center mt-[24px] mb-[32px]">
                ...
                <div className="text-[#666668] mb-[24px]">
                    ...
                    <div className="w-full h-[10px] bg-[#EAF3F9] mt-[8px] rounded-[50px] ">
                        <div className={`h-[10px] bg-[#216388] rounded-[50px] duration-400`}
                            style={{width: `${currentProgress !== undefined ? currentProgress : 0}%`}}
                        ></div>
                    </div>
                </div>
                {
