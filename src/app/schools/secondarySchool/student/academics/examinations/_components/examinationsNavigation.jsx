...
export const ExaminationsNavigation = () => {
    ...
    return (
        <nav className="flex text-xl border-2 border-b-0 border-[#F2F4F7] bg-white rounded-t-[24px] ">
            ...
            <Link href={`${baseURL}/upcoming`}
                className={`w-auto cursor-pointer ${pathName === `${baseURL}/upcoming` ? `${activeStyles}` : `${baseStyles}`}`}
            >
                Upcoming
                <span className={notStyles}>
            ...
            <Link href={`${baseURL}/submitted`}
                className={`w-auto cursor-pointer ${pathName === `${baseURL}/submitted` ? `${activeStyles}` : `${baseStyles}`}`}
            >
                Submitted
                <span className={notStyles}>
