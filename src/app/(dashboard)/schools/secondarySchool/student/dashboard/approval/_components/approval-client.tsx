    ...
    <>
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-teal-700 hover:bg-teal-800 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 px-5 py-4 flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-full bg-teal-700 flex items-center justify-center flex-shrink-0">
